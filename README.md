...
* [AFNetworking](): Newly introduced NSURLSession has huge improvement over NSURLConnection, but AFNetworking make implementing RESTfull services client much simpler.

* [CocoPod](): It's not really a *library*, but it makes adding other libraries so much easier.
